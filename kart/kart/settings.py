...
SECRET_KEY = 'django-insecure-8n=&_jivnpg0ihj2*&4u9(eyt%kd9lruz)3mjg%a%o!j*rw#@*'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "MyStore Admin Panel",
    "site_brand": "MyStore",
    "welcome_sign": "Welcome to MyStore Admin",
